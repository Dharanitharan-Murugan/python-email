...
#credentials
username, password = 'dharani.python@gmail.com', 'xxxxxxxx'
...
send_email(subject='Different Subject - Python3', to_addrs=['dharani.python@gmail.com', 'dharanitharan.it@gmail.com'], html=htmlTemplate)